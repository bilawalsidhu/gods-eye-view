...
| `flowVersion`           | `GODS_EYE_FLOW_VERSION`               | —                      | `'1'` (`FLOW_DEFAULTS.flowVersion`, Gate 6 2026-09-18)          | informational only; workflow versioning is NOT FOUND IN LIVE DOCS (§7.3) — the repo's own label of the created workflow definition                                                                                                                                                 |
| `spatialFlowId`         | `ONDEMAND_SPATIAL_FLOW_ID`            | —                      | `'6aace534859f7b0abb53d99a'` (`FLOW_DEFAULTS.spatialFlowId`)     | Gate 6 (2026-09-18): the REAL id returned by the documented `POST /automation/api/workflow/` (201, 07:16:04Z) for `GodsEye Advanced Spatial Workflow` v1 — docs/ondemand-workflows/README.md; a workflow id is not a secret                                                                                                                                                                                                                        |
