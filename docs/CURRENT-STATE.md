...
| CCTV | Austin + Caltrans (CA) + TfL London + Ontario 511 + Fintraffic (FI) + DriveBC (BC) + TxDOT (TX) + Estonia (Tallinn, Tarktee) + Live Traffic NSW + Open Calgary Open Data + Colorado DOT / COtrip + Street View fallback | `src/data/cctv.js` | `/api/cctv` | 10s (active) |
