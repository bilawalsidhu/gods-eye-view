...
| 2 | Agent "OnDemand Spatial Intelligence Agent" | **DASHBOARD-ONLY, pending** — `PENDING-HUMAN` as of 2026-09-19 (paste `docs/registration/READY_TO_PASTE.md` §3, click path §4.4; see §6.1) | Not yet created; no id. Field values and system prompt to paste are in §2. | `https://docs.on-demand.io/docs/rest-based-plugins.md` (fetched 2026-09-18T07:20:32Z); `https://docs.on-demand.io/docs/agent-skills.md` (fetched 2026-09-18T07:20:32Z); live probe below |
| 3 | earthquake_search REST agent | **DASHBOARD-ONLY, pending** — `PENDING-HUMAN` as of 2026-09-19 (paste `docs/registration/READY_TO_PASTE.md` §1, click path §4.1/§4.2; the undocumented MCP/REST create surface answered HTTP 500 — see §6.1) | Not yet created; no id (`ondemand_tool_id` is `null` in the registry). Files to paste are in §3. | `https://docs.on-demand.io/docs/rest-based-plugins.md` (fetched 2026-09-18T07:20:32Z); `https://docs.on-demand.io/docs/open-api-schema.md` (fetched 2026-09-18T07:20:33Z) |
| 4 | 9 OnDemand Spatial skills | **DASHBOARD-ONLY, pending** — `PENDING-HUMAN` as of 2026-09-19 (paste `docs/registration/READY_TO_PASTE.md` §2.1–§2.9, click path §4.3; see §6.1) | Not yet created; `ondemand.skills[]` all have `skillId: null`. Table and file paths are in §4. | `https://docs.on-demand.io/docs/agent-skills.md` (fetched 2026-09-18T07:20:32Z) |
...
### 6.1 Registration results — platform attempt 2026-09-19 (appended 2026-09-19T12:09:46Z)
...
_Status 2026-09-19: all four remain open — `PENDING-HUMAN`. The platform attempt of 2026-09-19 created nothing (§6.1); use the paste blocks in `docs/registration/READY_TO_PASTE.md` (§3 agent, §1 tool, §2.1–§2.9 skills, §4 click paths)._
