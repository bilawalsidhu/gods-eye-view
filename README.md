...
| 🌦️ **Observed Weather**     | Rain radar (contiguous US), Satellite clouds (GOES regional or global infrared, Clouds only or Full image) and Lightning density (Americas and Pacific) on one history timeline                                                                                                                                                                                                     | NOAA nowCOAST (+ optional Xweather)     | 🟢 (🟡 optional Xweather for global radar and lightning)                                            |
