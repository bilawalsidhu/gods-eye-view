...
| 🛰️ **Satellites**           | ~880-object catalog (including ICEYE radar-imaging satellites), color-coded by class with a live legend — the **DENSE** chip drops in the whole Starlink shell                                                                                                                                                                                                                                                                  | CelesTrak                               | 🟢                                                                                                  |
