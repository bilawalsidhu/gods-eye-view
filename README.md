...
| 📹 **CCTV Mesh** | Public cameras projected *into* the 3D space — Austin · California (Caltrans) · London (TfL) · Hong Kong · British Columbia (DriveBC) · Ontario 511 · Finland (Digitraffic) · New Zealand (NZTA), plus the global Windy webcam directory with a key. Positions are published; poses are estimated priors **you calibrate by dragging a gizmo on the camera itself** | City and national open-data APIs · Windy | 🟢 · 🟡 Windy |
