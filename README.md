...
| 🔥 **Historic Fires**       | Archived NASA FIRMS detections for registered past wildfires (Camp Fire 2018, Lahaina 2023, Park Fire 2024), colored early → late across the event window, with a spread replay, the NIFC final perimeter, a context panel and voice control                                                                                                                                                                                       | NASA FIRMS archive · NIFC Open Data     | 🟡 (same `FIRMS_MAP_KEY`)                                                                          |
