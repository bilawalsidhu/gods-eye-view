...
| 📻 **Repeaters**            | FM and D-STAR amateur-radio repeaters around the view once you fly in close, each row naming its source, confidence and record date — a directory, not a coverage map. *"Zeig mir die 70-cm-Relais um München."* | HamRig repeater tables (see `DATA_SOURCES.md`) | 🟢 |
