...
| 📹 **CCTV Mesh** | ~1,050 public cameras projected *into* the 3D space — Austin · California (Caltrans) · London (TfL) · Amsterdam (positions only — the city publishes where its cameras are, not their imagery). Positions are published; poses are estimated priors **you calibrate by dragging a gizmo on the camera itself** | City APIs | 🟢 |
