...
| 🔥 **Historic Fires**       | Archived NASA FIRMS detections for registered past wildfires (Camp Fire 2018, Lahaina 2023, Park Fire 2024), colored early → late across the event window; pick the event from the row chips                                                                                                                                                                                       | NASA FIRMS archive                      | 🟡 (same `FIRMS_MAP_KEY`)                                                                          |
