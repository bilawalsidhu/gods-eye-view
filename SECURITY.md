...
| `MAPILLARY_ACCESS_TOKEN` | Server only | Browser requests bounded metadata through `/api/mapillary/images`; the token is sent only to the fixed Mapillary Graph host |
