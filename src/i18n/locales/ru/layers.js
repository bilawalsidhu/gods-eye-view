...
export default {
  ...
  'cctv.adjustTitle': 'Перетащите камеру в мире: кольца вращают, стрелки перемещают, маркеры задают дальность/FOV',
  ...
  'cctv.calRangeTitle': 'Дальность / расстояние до плоскости монитора (м) — нажмите для ввода',
  'cctv.calHeightTitle': 'Высота крепления над землёй (м) — нажмите для ввода',
  'cctv.calNorthTitle': 'Смещение на север от позиции каталога (м) — нажмите для ввода',
  'cctv.calEastTitle': 'Смещение на восток от позиции каталога (м) — нажмите для ввода',
  ...
  'radio.panelAriaLabel': 'Интернет-радио',
  ...
  'radio.stationHint': 'Включите Радио, затем выберите маркер на глобусе или нажмите «След.».',
  ...
  'radio.privacyNote': 'После нажатия «Пуск» аудио подключается напрямую к вещателю. Ваш IP виден этому вещателю.',
  ...
  'meta.uncertainLifecycle': 'НЕОПРЕД. · {source} · требуется сверка жизненного цикла',
  ...
  'cctv.summary.standingBy': 'КАМЕР В ГОТОВНОСТИ: {count} · КАМЕРА НЕ ВЫБРАНА · НАЖМИТЕ КАМЕРУ ДЛЯ АКТИВАЦИИ',
  ...
  'radio.state.ready': 'Готово — воспроизведение начинается только по вашему действию',
  ...
  'radio.state.voiceRestoring': ' · восстановление громкости после голосовой сессии',
  ...
  'radio.state.stationUnavailable': 'Станция недоступна после обновления каталога — выберите другой канал',
  'radio.state.enabling': 'Радио включается…',
  'radio.state.disabling': 'Радио выключается…',
  'radio.state.uncertain': 'Жизненный цикл Радио неопределён — используйте «Включить» или «Выключить» для сверки',
  ...
  'missions.rows.noStageData': 'НЕТ ДАННЫХ О ВХОДЕ В АТМОСФЕРУ / СПАСЕНИИ СТУПЕНИ',
  ...
  'missions.replay.startTitle': 'Повторить расчётное выведение с камерой сопровождения',
  ...
  'satellites.denseTitleAdd': 'Добавить полную широкополосную оболочку Starlink (тысячи дополнительных точек)',
  ...
  'satellites.denseTitleActive': 'Показана полная оболочка Starlink — нажмите для основного каталога',
  'satellites.class.station': 'СТАНЦИЯ',
  'satellites.class.stationBlurb': 'Пилотируемые станции и прибывающие к ним корабли',
  'satellites.class.nav': 'NAV',
  'satellites.class.navBlurb': 'Навигация GNSS — GPS, ГЛОНАСС, Galileo',
  'satellites.class.geo': 'GEO',
  'satellites.class.geoBlurb': 'Геостационарный пояс — связь и погода, фиксированы над экватором',
  'satellites.class.visual': 'ВИДИМЫЕ',
  'satellites.class.visualBlurb': 'Самые яркие объекты невооружённым глазом — визуальная группа CelesTrak',
  'satellites.class.comms': 'СВЯЗЬ',
  'satellites.class.commsBlurb': 'Оболочка широкополосной группировки — только в режиме ПЛОТНО',
  ...
  'traffic.liveCoverage': 'В РЕАЛЬНОМ ВРЕМЕНИ · поток TomTom · обзор {percent}%',
  ...
  'installations.feedback.reason.rateLimited': 'Overpass: превышен лимит запросов',
  'installations.feedback.reason.timeout': 'Overpass: истекло время ожидания',
  'installations.feedback.reason.queryFailed': 'Overpass не смог завершить запрос',
  ...
  'awareness.next': 'СЛЕД.',
  'awareness.previousTitle': 'Предыдущий — уже просмотренный контакт в окне 250 KM',
  'awareness.nextTitle': 'Следующий — ближайший непросмотренный контакт в окне 250 KM',
  'awareness.note': 'Контекст из открытых источников. Отсутствие трансляций, незагруженные области карты или неотмеченные объекты — не доказательство отсутствия.',
  ...
  'awareness.reason.none': 'нет наблюдаемых или картографированных объектов в текущих каналах',
