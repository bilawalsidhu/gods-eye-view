...
export default {
  ...
  'presets.styleCrtTitle': 'Emula un CRT de fósforo verde con líneas de barrido y curvatura de pantalla.',
  'presets.styleCrtLabel': 'CRT',
  'presets.styleNvgTitle': 'Simula unas gafas de visión nocturna con intensificación verde y viñeta de tubo.',
  'presets.styleNvgLabel': 'NVG',
  'presets.styleFlirTitle': 'Simula un contraste térmico estilo FLIR. Sube Ironbow para tener color.',
  'presets.styleFlirLabel': 'FLIR',
  'presets.styleAnimeTitle': 'Aplica un color brillante de cel-shading y contornos ilustrados.',
  'presets.styleAnimeLabel': 'Anime',
  'presets.styleNoirTitle': 'Aplica una gradación monocroma de alto contraste estilo film noir.',
  'presets.styleNoirLabel': 'Noir',
  'presets.styleSnowTitle': 'Añade a la escena un tratamiento frío de ventisca blanca.',
  ...
  'display.fadeTitle': 'Distancia de desvanecimiento de la superposición del mundo fuera del ojo de cerradura, como porcentaje de su radio',
  'display.outsideLabel': 'Exterior',
  'display.outsideAriaLabel': 'Opacidad de detección fuera del ojo de cerradura',
  'display.outsideTitle': 'Opacidad de etiquetas y tarjetas de la superposición del mundo más allá de la distancia de desvanecimiento',
  'display.parametersTitle': 'PARÁMETROS',
  'display.parametersCollapseTitle': 'Contraer panel',
  'display.modelsToggleTitle': 'Aeronaves 3D — iconos planos de lejos, modelos 3D de cerca',
  ...
  'display.featherTitle': 'Difuminado del borde de la mirilla como porcentaje del radio del ojo de cerradura',
  'display.celestialToggleTitle': 'Anillo celestial — muestra el globo completo',
  ...
  'vision.currentAriaLabel': 'Estilo de visión de cabina actual: NORMAL. Actívalo para pasar al siguiente estilo.',
  ...
  'brief.autoTitle': 'Cambia las páginas de información automáticamente cada 9 segundos (Señales → Noticias → Local). Se pausa mientras pasas el cursor por el panel o lo enfocas. Los datos de señales en vivo se actualizan continuamente de todos modos.',
  ...
  'context.previousAriaLabel': 'Anterior — contacto ya visitado en la ventana de 250 km',
  'context.previousTitle': 'Anterior — contacto ya visitado en la ventana de 250 km',
  'context.nextAriaLabel': 'Siguiente — contacto sin visitar más cercano en la ventana de 250 km',
  'context.nextTitle': 'Siguiente — contacto sin visitar más cercano en la ventana de 250 km',
  ...
  'context.uncertaintyNote': 'SOLO DATOS DISPONIBLES · NO IMPLICA TODO DESPEJADO',
  'context.weatherEnableAriaLabel': 'Activar los efectos climáticos de la cabina',
  ...
  'context.contactsTabTitle': 'Ronda por los contactos más cercanos del tipo que elijas — aeronaves, embarcaciones, instalaciones. Los satélites se rastrean por separado.',
  ...
  'context.awarenessOffHint': 'SELECCIONA CONTACTOS PARA CARGAR LA PROXIMIDAD OBSERVADA / MAPEADA',
  ...
  'context.radioMiniPlayAriaLabel': 'Reproducir la emisora de radio seleccionada',
  ...
  'utility.controlsAriaLabel': 'Controles de visualización y Radio de la cabina',
  'utility.displayLabel': 'VISUALIZACIÓN',
  'utility.radioLabel': 'RADIO',
  'utility.displayToggleAriaLabel': 'Expandir las opciones de visualización de la cabina',
  'utility.displayToggleTitle': 'Expandir las opciones de visualización de la cabina',
  'utility.displayPanelAriaLabel': 'Opciones de visualización de la cabina',
  'utility.radioToggleAriaLabel': 'Expandir los controles de Radio de la cabina',
  ...
  'context.weatherDisableAriaLabel': 'Desactivar los efectos climáticos de la cabina',
  ...
  'vision.currentAriaTemplate': 'Estilo de visión de cabina actual: {style}. Actívalo para pasar al siguiente estilo.',
  'vision.currentTitleTemplate': 'Estilo actual: {style} — haz clic para el siguiente',
  ...
  'signal.contextStandbyHint': 'ACTIVAR CONTEXTO GLOBAL PARA PINGS DE PROXIMIDAD',
  'signal.contactLostTitle': 'CONTACTO PERDIDO · {subject}',
  'signal.contactLostDetail': 'EL OBJETIVO SALIÓ DE SU FUENTE · LA LECTURA CONSERVA EL ÚLTIMO DATO CONOCIDO',
  ...
  'context.uncertaintyContactLost': 'CONTACTO PERDIDO · ÚLTIMA LECTURA CONOCIDA · NO IMPLICA TODO DESPEJADO',
  ...
  'panel.layoutResetToast': 'Disposición de paneles actualizada — posiciones restablecidas a los nuevos valores predeterminados',
  ...
  'actions.clearLayersFailedToast': 'No se pudieron limpiar las capas de datos seleccionadas',
  ...
  'context.toastStartBlocked': '{mode} no pudo iniciarse porque otra capa no se detuvo correctamente',
  'context.toastTransitionFailedContacts': 'Contactos no pudo completar la transición solicitada; inténtalo de nuevo',
  'context.toastTransitionFailedMissions': 'Misiones espaciales no pudo completar la transición solicitada; inténtalo de nuevo',
  'context.toastInstallationsRefreshFailed': 'No se pudieron actualizar las instalaciones cercanas; inténtalo de nuevo',
  'context.toastRestoreFailed': 'Contexto no pudo restaurar todas las capas; inténtalo de nuevo',
  ...
  'context.standbyContactsDesc': 'CONTACTOS — aeronaves · embarcaciones · sitios más cercanos',
  'context.standbyMissionsDesc': 'MISIONES ESPACIALES — lanzamientos y activos orbitales',
  // _syncContextRadioLauncherState(): close-state sibling of the seeded
  // context.radioToggleAriaLabel ('Open compact Radio controls').
  'context.radioToggleCloseAriaLabel': 'Cerrar los controles compactos de Radio',
  'context.toastMissionsCancelRestoreFailed': 'La cancelación de Misiones espaciales no pudo restaurar el estado previo de las capas',
  // Cockpit utility disclosures: collapse-state siblings of the seeded
  // utility.*ToggleAriaLabel expand keys.
  'utility.displayToggleCollapseAriaLabel': 'Contraer las opciones de visualización de la cabina',
  'utility.radioToggleCollapseAriaLabel': 'Contraer los controles de Radio de la cabina',
  ...
  'cctv.metaTemplate': '{city} · HDG {heading} · FOV {fov} · ALCANCE {range}m · {projection}{calBadge} · {provider}{status}',
  ...
  'display.celestialUnavailableTitle': 'Anillo celestial — disponible en el estilo Normal',
  ...
  'hud.resetGlobeCockpitAria': 'Restablecer la cabina a la vista de globo completo',
  'hud.resettingGlobeAria': 'Restableciendo la vista de globo completo',
  'hud.resettingGlobeCockpitAria': 'Restableciendo la cabina a la vista de globo completo',
