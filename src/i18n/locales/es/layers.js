...
export default {
  ...
  'meta.uncertainLifecycle': 'UNCERTAIN · {source} · lifecycle state requires reconciliation',
  ...
  'meta.stateSourceAgoRetry': '{state} · {source} · {ago} · retrying in {seconds}s',
  ...
  'cctv.summary.standingBy': '{count} CAMERAS STANDING BY · NO CAMERA SELECTED · CLICK A CAMERA TO ACTIVATE',
  ...
  'radio.pause': 'PAUSE',
  'radio.resume': 'RESUME',
  'radio.playNearestAria': 'Play nearest station',
  'radio.pauseSelectedAria': 'Pause selected station',
  'radio.pauseNearestAria': 'Pause nearest station',
  'radio.resumeSelectedAria': 'Resume selected station',
  'radio.resumeNearestAria': 'Resume nearest station',
  ...
  'radio.state.stationUnavailable': 'Station unavailable after directory refresh — choose another channel',
  'radio.state.enabling': 'Radio is enabling…',
  'radio.state.disabling': 'Radio is disabling…',
  'radio.state.uncertain': 'Radio lifecycle is uncertain — use Enable or Disable to reconcile',
  ...
  'missions.rows.classified': 'CLASSIFIED / MULTI-PAYLOAD',
  ...
  'missions.replay.startTitle': 'Replay the estimated ascent with a following camera',
  ...
  'satellites.class.geoBlurb': 'Geostationary belt — comms and weather, fixed over the equator',
  'satellites.class.visual': 'VISUAL',
  'satellites.class.visualBlurb': 'Brightest naked-eye objects — CelesTrak visual group',
  ...
  'installations.feedback.reason.queryFailed': 'Overpass could not complete the query',
  'installations.feedback.reason.unavailable': 'Overpass temporarily unavailable',
