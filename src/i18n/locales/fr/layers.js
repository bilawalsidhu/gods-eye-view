...
export default {
  ...
  'cctv.adjustTitle': 'Faites glisser la caméra dans le monde : les anneaux pivotent, les flèches se déplacent, les poignées règlent la portée/FOV',
  'cctv.calPoseAriaLabel': 'Pose de la caméra — cliquez sur une valeur pour la saisir',
  ...
  'cctv.calRangeTitle': 'Portée / distance au plan du moniteur (m) — cliquez pour saisir',
  'cctv.calHeightTitle': 'Hauteur de montage au-dessus du sol (m) — cliquez pour saisir',
  'cctv.calNorthTitle': 'Décalage nord depuis la position du catalogue (m) — cliquez pour saisir',
  'cctv.calEastTitle': 'Décalage est depuis la position du catalogue (m) — cliquez pour saisir',
  'cctv.saveCal': 'ENREGISTRER CAL',
  'cctv.resetCal': 'RÉINITIALISER CAL',
  'cctv.summaryLabel': 'RÉSUMÉ DE SCÈNE',
  'cctv.summaryIdle': 'Activez CCTV pour lancer les résumés de renseignement liés aux caméras.',

  // index.html Radio panel chrome (right rail #radio-panel)
  'radio.panelAriaLabel': 'Compagnon radio Internet',
  ...
  'radio.stationHint': 'Activez Radio, puis choisissez un marqueur du globe ou utilisez suivant.',
  ...
  'meta.uncertainLifecycle': 'INCERTAIN · {source} · état du cycle de vie à réconcilier',
  'meta.transitioning': '{state} · {source}',
  'meta.stateSourceRetry': '{state} · {source} · {detail} · réessai dans {seconds}s',
  'meta.stateSourceDetail': '{state} · {source} · {detail}',
  'meta.stateSourceAgo': '{state} · {source} · {ago}',
  'meta.stateSourceAgoRetry': '{state} · {source} · {ago} · réessai dans {seconds}s',
  ...
  'radio.meta.chooseHint': 'Choisissez un marqueur du globe ou utilisez suivant.',
  ...
  'missions.roster.empty': 'AUCUNE MISSION DISPONIBLE DANS LA FENÊTRE ACTUELLE DE 30 JOURS',
  ...
  'missions.replay.startTitle': 'Rejouer la montée estimée avec une caméra de suivi',
  ...
  'satellites.denseTitleAdd': 'Ajouter la coquille Starlink complète (des milliers de points supplémentaires)',
  ...
  'satellites.denseTitleActive': 'Coquille Starlink complète affichée — cliquez pour le seul catalogue principal',
  'satellites.class.station': 'STATION',
  'satellites.class.stationBlurb': 'Stations habitées et leurs véhicules visiteurs',
  ...
  'installations.feedback.zoomIn': 'Zoomez pour rechercher des installations cartographiées',
  ...
  'awareness.standbySelect': 'SÉLECTIONNEZ UN VOL, UN NAVIRE OU UNE INSTALLATION CARTOGRAPHIÉE',
  'awareness.standbyEnable': 'ACTIVEZ POUR CHARGER LA PROXIMITÉ OBSERVÉE / CARTOGRAPHIÉE',
  ...
  'awareness.reason.none': 'aucun objet observé ou cartographié dans les flux actuels',
