...
export default {
  ...
  'cctv.adjustTitle': 'Перетягніть камеру у сцені: кільця обертаються, стрілки переміщуються, маркери задають дальність/FOV',
  ...
  'cctv.calRangeTitle': 'Дальність / відстань до площини монітора (м) — клацніть, щоб увести',
  'cctv.calHeightTitle': 'Висота кріплення над землею (м) — клацніть, щоб увести',
  'cctv.calNorthTitle': 'Зміщення на північ від позиції каталогу (м) — клацніть, щоб увести',
  'cctv.calEastTitle': 'Зміщення на схід від позиції каталогу (м) — клацніть, щоб увести',
  'cctv.saveCal': 'ЗБЕРЕГТИ КАЛ.',
  'cctv.resetCal': 'СКИНУТИ КАЛ.',
  'cctv.summaryLabel': 'ЗВЕДЕННЯ СЦЕНИ',
  'cctv.summaryIdle': 'Увімкніть CCTV, щоб почати зведення розвідки за камерами.',

  // index.html Radio panel chrome (right rail #radio-panel)
  'radio.panelAriaLabel': 'Панель інтернет-радіо',
  ...
  'radio.stationHint': 'Увімкніть радіо, потім виберіть маркер на глобусі або натисніть «наступна».',
  ...
  'radio.privacyNote': 'Після натискання відтворення аудіо з’єднується напряму з мовником. Мовник бачить вашу IP-адресу.',
  ...
  'meta.uncertainLifecycle': 'НЕВИЗНАЧЕНО · {source} · стан життєвого циклу потребує звірки',
  'meta.transitioning': '{state} · {source}',
  'meta.stateSourceRetry': '{state} · {source} · {detail} · повтор через {seconds} с',
  'meta.stateSourceDetail': '{state} · {source} · {detail}',
  'meta.stateSourceAgo': '{state} · {source} · {ago}',
  'meta.stateSourceAgoRetry': '{state} · {source} · {ago} · повтор через {seconds} с',
  ...
  'cctv.summary.standingBy': '{count} КАМЕР ОЧІКУЄ · КАМЕРУ НЕ ВИБРАНО · КЛАЦНІТЬ КАМЕРУ ДЛЯ АКТИВАЦІЇ',
  ...
  'radio.meta.chooseHint': 'Виберіть маркер на глобусі або натисніть «наступна».',
  ...
  'radio.state.stationUnavailable': 'Станція недоступна після оновлення каталогу — виберіть інший канал',
  'radio.state.enabling': 'Радіо вмикається…',
  'radio.state.disabling': 'Радіо вимикається…',
  'radio.state.uncertain': 'Стан радіо невизначений — звірте через «Увімкнути» або «Вимкнути»',
  ...
  'missions.rows.additionalPayloads': '+{count} додаткових записів корисного навантаження',
  ...
  'missions.replay.startTitle': 'Відтворити розрахунковий зліт із камерою-супроводом',
  ...
  'satellites.denseTitleAdd': 'Додати повну широкосмугову оболонку Starlink (тисячі додаткових точок)',
  ...
  'satellites.denseTitleActive': 'Показано повну оболонку Starlink — клацніть, щоб лишити лише основний каталог',
  ...
  'satellites.class.geoBlurb': 'Геостаціонарний пояс — зв’язок і погода, нерухомо над екватором',
  'satellites.class.visual': 'ВИДИМІ',
  'satellites.class.visualBlurb': 'Найяскравіші об’єкти для неозброєного ока — група visual CelesTrak',
  'satellites.class.comms': 'ЗВ’ЯЗОК',
  'satellites.class.commsBlurb': 'Оболонка широкосмугового угруповання — лише в режимі ЩІЛЬНО',
  ...
  'traffic.liveCoverage': 'У РЕАЛЬНОМУ ЧАСІ · потік TomTom · {percent}% покриття',
  ...
  'installations.feedback.reason.rateLimited': 'Overpass обмежує частоту запитів',
  'installations.feedback.reason.timeout': 'Перевищено час очікування Overpass',
  'installations.feedback.reason.queryFailed': 'Overpass не зміг завершити запит',
  'installations.feedback.reason.unavailable': 'Overpass тимчасово недоступний',
  'installations.feedback.retrying': 'Повторне завантаження нанесених об’єктів…',
  ...
  'installations.feedback.zoomIn': 'Наблизьте карту, щоб шукати нанесені об’єкти',
  ...
  'awareness.standbyEnable': 'УВІМКНІТЬ ДЛЯ ЗАВАНТАЖЕННЯ СПОСТЕРЕЖЕНОЇ / НАНЕСЕНОЇ ОКРУГИ',
  ...
  'awareness.note': 'Контекст із відкритих джерел (нанесений/спостережений). Відсутність трансляцій, незавантажені ділянки карти або ненанесені об’єкти не є доказом відсутності.',
  ...
  'awareness.reason.none': 'немає спостережених або нанесених об’єктів у поточних каналах даних',
