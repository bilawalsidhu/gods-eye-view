...
async function init() {
  ...
  try {
    ...
    dataManager.register(webReceiversLayer);
    // Amateur-radio companions (HamRig). Registration order = Data-panel row order.
    dataManager.register(dxSpotsLayer);
    dxSpotsLayer.setDataManager(dataManager);
    dataManager.register(hamActivationsLayer);
    dataManager.register(dxpeditionsLayer);
    dataManager.register(hamBeaconsLayer);
    hamBeaconsLayer.setDataManager(dataManager);
    dataManager.register(hamPropagationLayer);
    dataManager.register(hamRepeatersLayer);
    dataManager.register(hamStationsLayer);
