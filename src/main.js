...
import weatherBalloonsLayer from './data/weatherBalloons.js';
import glidersLayer from './data/gliders.js';
...
async function init() {
  ...
  try {
    ...
    dataManager.register(weatherBalloonsLayer);
    dataManager.register(glidersLayer);
