...
test('the voice TOOL SCHEMA matches the pinned release — the mission mapping is instructions only', () => {
  // ALPR and Meteors deliberately add their IDs to the two layer menus and visibility aliases.
  ...
  assert.equal(block.length, 26228, 'serialized tool schema length drifted');
  assert.equal(
    crypto.createHash('sha256').update(block).digest('hex'),
    'd3a654d7fde08db7a97b47ed927616fda064a0cfa06e3bbd81ec5a7ee39db6b9',
