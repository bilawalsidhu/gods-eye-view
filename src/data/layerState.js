...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'dx-spots', token: 'j', disposition: 'enabled-only' }),
  Object.freeze({ id: 'dxpeditions', token: 'p', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'ham-activations', token: 'n', disposition: 'enabled-only' }),
  Object.freeze({ id: 'ham-beacons', token: 'o', disposition: 'enabled-only' }),
  Object.freeze({ id: 'ham-propagation', token: 'v', disposition: 'enabled-only' }),
  Object.freeze({ id: 'ham-repeaters', token: 'l', disposition: 'enabled-only' }),
  Object.freeze({ id: 'ham-stations', token: 'y', disposition: 'enabled-only' }),
  ...
  Object.freeze({ id: 'web-receivers', token: 'h', disposition: 'enabled-only' }),
]);
