...
/**
 * Re-exported from `./tileBudget.js`, which every keyed tile proxy shares.
 * Nothing in that accounting was ever TomTom-specific; it lives here too so the
 * traffic provider and its tests keep one import for tile math and budget.
 */
export { utcDayKey, normalizeBudget, isOverBudget } from './tileBudget.js';
