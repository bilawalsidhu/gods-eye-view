...
const RAW_GBFS_CITY_REGISTRY = [
  ...
  },
  {
    ...
    centerLon: -46.6333,
    loadRadiusKm: 100,
    stationInformationUrl: 'https://saopaulo.publicbikesystem.net/customer/gbfs/v2/en/station_information.json',
    stationStatusUrl: 'https://saopaulo.publicbikesystem.net/customer/gbfs/v2/en/station_status.json',
    provider: 'Bike Itaú',
  },
  {
    ...
    centerLon: -43.1729,
    loadRadiusKm: 100,
    stationInformationUrl: 'https://riodejaneiro.publicbikesystem.net/customer/gbfs/v2/en/station_information.json',
    stationStatusUrl: 'https://riodejaneiro.publicbikesystem.net/customer/gbfs/v2/en/station_status.json',
    provider: 'Bike Itaú',
  },
  {
    ...
    centerLon: -38.5016,
    loadRadiusKm: 90,
    stationInformationUrl: 'https://salvador.publicbikesystem.net/customer/gbfs/v2/en/station_information.json',
    stationStatusUrl: 'https://salvador.publicbikesystem.net/customer/gbfs/v2/en/station_status.json',
    provider: 'Bike Itaú',
  },
  {
    id: 'recife-bike-itau',
    ...
    centerLon: -34.8770,
    loadRadiusKm: 90,
    stationInformationUrl: 'https://recife.publicbikesystem.net/customer/gbfs/v2/en/station_information.json',
    stationStatusUrl: 'https://recife.publicbikesystem.net/customer/gbfs/v2/en/station_status.json',
    provider: 'Bike Itaú',
  },
  {
    ...
    centerLon: -51.2177,
    loadRadiusKm: 90,
    stationInformationUrl: 'https://portoalegre.publicbikesystem.net/customer/gbfs/v2/en/station_information.json',
    stationStatusUrl: 'https://portoalegre.publicbikesystem.net/customer/gbfs/v2/en/station_status.json',
    provider: 'Bike Itaú',
  },
  {
    ...
    centerLon: -47.8828,
    loadRadiusKm: 90,
    stationInformationUrl: 'https://brasilia.publicbikesystem.net/customer/gbfs/v2/en/station_information.json',
    stationStatusUrl: 'https://brasilia.publicbikesystem.net/customer/gbfs/v2/en/station_status.json',
    provider: 'Bike Itaú',
  },
  {
    ...
    centerLon: -49.2733,
    loadRadiusKm: 90,
    stationInformationUrl: 'https://curitiba.publicbikesystem.net/customer/gbfs/v2/en/station_information.json',
    stationStatusUrl: 'https://curitiba.publicbikesystem.net/customer/gbfs/v2/en/station_status.json',
    provider: 'Bike Itaú',
  },
  bcycleEntry({
    id: 'boulder-bcycle',
