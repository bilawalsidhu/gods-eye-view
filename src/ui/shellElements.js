...
export function readShellElements(document = globalThis.document) {
  return {
    ...
    _weatherPanel: document.getElementById('weather-panel'),
    _weatherOverlays: document.getElementById('weather-overlays'),
    _weatherFields: document.getElementById('weather-fields'),
    _weatherRefreshBtn: document.getElementById('weather-refresh-btn'),
    _weatherAutoBtn: document.getElementById('weather-auto-btn'),
    _weatherInterval: document.getElementById('weather-interval'),
    _weatherBudget: document.getElementById('weather-budget'),
    _weatherUnavailable: document.getElementById('weather-panel-unavailable'),
