...
export function readShellElements(document = globalThis.document) {
  return {
    ...
    _hamRepeatersPanel: document.getElementById('ham-repeaters-panel'),
    _hamRepeatersLayerState: document.getElementById(
      'ham-repeaters-layer-state',
    ),
    _hamRepeatersEnableBtn: document.getElementById('ham-repeaters-enable-btn'),
    _hamRepeatersSummary: document.getElementById('ham-repeaters-summary'),
    _hamRepeatersRadius: document.getElementById('ham-repeaters-radius'),
    _hamRepeatersBand: document.getElementById('ham-repeaters-band'),
    _hamRepeatersKind: document.getElementById('ham-repeaters-kind'),
    _hamRepeatersLoadBtn: document.getElementById('ham-repeaters-load-btn'),
    _hamRepeatersArea: document.getElementById('ham-repeaters-area'),
    _hamRepeatersList: document.getElementById('ham-repeaters-list'),
