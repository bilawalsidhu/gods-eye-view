...
export function readShellElements(document = globalThis.document) {
  return {
    ...
    _webReceiversPanel: document.getElementById('web-receivers-panel'),
    _webReceiversLayerState: document.getElementById(
      'web-receivers-layer-state',
    ),
    _webReceiversEnableBtn: document.getElementById('web-receivers-enable-btn'),
    _webReceiversType: document.getElementById('web-receivers-type'),
    _webReceiversBand: document.getElementById('web-receivers-band'),
    _webReceiversName: document.getElementById('web-receivers-name'),
    _webReceiversMeta: document.getElementById('web-receivers-meta'),
    _webReceiversBands: document.getElementById('web-receivers-bands'),
    _webReceiversFreq: document.getElementById('web-receivers-freq'),
    _webReceiversMode: document.getElementById('web-receivers-mode'),
    _webReceiversTuneBtn: document.getElementById('web-receivers-tune-btn'),
    _webReceiversOpenBtn: document.getElementById('web-receivers-open-btn'),
    _webReceiversSpecFrom: document.getElementById('web-receivers-spec-from'),
    _webReceiversSpecTo: document.getElementById('web-receivers-spec-to'),
    _webReceiversSpecBtn: document.getElementById('web-receivers-spec-btn'),
    _webReceiversDock: document.getElementById('web-receivers-dock'),
    _webReceiversDockLabel: document.getElementById('web-receivers-dock-label'),
    _webReceiversDockLink: document.getElementById('web-receivers-dock-link'),
    _webReceiversDockMin: document.getElementById('web-receivers-dock-min'),
    _webReceiversDockClose: document.getElementById('web-receivers-dock-close'),
    _webReceiversFrame: document.getElementById('web-receivers-frame'),
    _webReceiversDockNote: document.getElementById('web-receivers-dock-note'),
    _webReceiversStatus: document.getElementById('web-receivers-status'),
