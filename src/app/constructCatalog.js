...
import { createApplicationTectonicPlates } from './layers/tectonicPlates.js';
  ...
  try {
    ...
    const catalog = createLayerCatalog(
      [
        ...
        createApplicationTectonicPlates({ source: sources.tectonicPlates }),
