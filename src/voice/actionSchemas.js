...
const schemas = [
  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        latitude: { type: 'number', minimum: -90, maximum: 90 },
        longitude: { type: 'number', minimum: -180, maximum: 180 },
        frequencyKhz: { type: 'number', minimum: 1, maximum: 10000000 },
        band: { type: 'string', enum: ['all', 'lf-mw', 'hf', 'vhf', 'uhf'] },
        receiverType: {
          type: 'string',
          enum: ['all', 'kiwisdr', 'websdr', 'openwebrx'],
        },
        limit: { type: 'integer', minimum: 1, maximum: 20 },
        frameResults: { type: 'boolean' },
      },
    },
  },
  {
    ...
    parameters: {
      ...
      properties: {
        receiverId: { type: 'string', maxLength: 40 },
        receiverQuery: { type: 'string', maxLength: 120 },
        target: { type: 'string', enum: ['selected', 'nearest'] },
        frequencyKhz: { type: 'number', minimum: 1, maximum: 10000000 },
        mode: {
          type: 'string',
          enum: ['usb', 'lsb', 'am', 'cw', 'nfm', 'wfm'],
        },
        locationQuery: { type: 'string', maxLength: 120 },
        locationId: {
          type: 'string',
  ...
  },
  {
    ...
    parameters: {
      ...
      additionalProperties: false,
      properties: {
        startKhz: { type: 'number', minimum: 1, maximum: 10000000 },
        stopKhz: { type: 'number', minimum: 1, maximum: 10000000 },
        centerKhz: { type: 'number', minimum: 1, maximum: 10000000 },
        spanKhz: { type: 'number', minimum: 1, maximum: 40000 },
        receiverId: { type: 'string', maxLength: 40 },
        receiverQuery: { type: 'string', maxLength: 120 },
        target: { type: 'string', enum: ['selected', 'nearest'] },
        locationQuery: { type: 'string', maxLength: 120 },
