  ...
  if (!root) {
    ...
    root.innerHTML = `
      <div class="gev-voice-heading">
        <div class="gev-voice-kicker" data-i18n="voice.kicker">AI AGENT</div>
        <div id="gev-voice-status" data-i18n="voice.off">OFF</div>
        <div class="gev-voice-cost">
          <button id="gev-voice-tier" class="gev-voice-tier-btn" type="button" aria-pressed="false" title="Voice model tier — applies next session" data-i18n-title="voice.tierTitle">STD</button>
          <span id="gev-voice-cost-value" class="gev-voice-cost-value" data-level="ok" title="Estimated session cost" data-i18n-title="voice.costTitle">~$0.00</span>
        </div>
      </div>
      <button id="gev-voice-button" type="button" aria-label="Voice control — activate to toggle voice; hold Space to speak" data-i18n-aria-label="voice.buttonAria" aria-describedby="gev-voice-help">
        <span class="gev-mic-orbit"><img src="/mic.svg" alt="" /></span>
        <span class="gev-mic-label" data-i18n="voice.onOff">ON/OFF</span>
      </button>
      ...
      <div class="gev-voice-readout">
        <div id="gev-voice-detail" data-i18n="voice.standby">VOICE STANDBY</div>
      </div>
      <div id="gev-voice-help" class="gev-voice-help-tray" role="tooltip">
        <span class="gev-voice-help-kicker" data-i18n="voice.helpKicker">VOICE CONTROL</span>
        <span class="gev-voice-help-detail" data-i18n="voice.helpDetail">Hold Space to speak · tap Space to activate focused controls</span>
      </div>
      <div class="gev-voice-error-tray" role="alert" aria-live="assertive">
        <div class="gev-voice-error-header">
          <span data-i18n="voice.systemError">VOICE SYSTEM ERROR</span>
          <button class="gev-voice-error-dismiss" type="button" data-i18n="voice.dismiss">DISMISS</button>
        </div>
        <div id="gev-voice-error-detail"></div>
        <div class="gev-voice-error-hint" data-i18n="voice.errorHint">Check microphone permission and network access, then try again.</div>
      </div>
    `;
