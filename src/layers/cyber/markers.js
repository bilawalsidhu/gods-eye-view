...
const GLYPHS = {
  ...
  both:
    '<path d="M24 10 37 15v9c0 9-5.7 15-13 19-7.3-4-13-10-13-19v-9z" fill="#202431" stroke="white" stroke-width="2.5"/><path d="m17 18 14 14m0-14L17 32" fill="none" stroke="white" stroke-width="3" stroke-linecap="round"/><path d="m15 16 4 1-2 4zm18 0-4 1 2 4zM15 34l4-1-2-4zm18 0-4-1 2-4z"/>',
  shodan:
