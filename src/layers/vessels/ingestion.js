...
export function createIngestion({
  ...
  function vesselDisplayRow(record) {
    return {
      ...
      draught: record.draughtM,
      load_state: record.loadState,
      eta: record.eta,
      length: record.lengthM,
      beam: record.beamM,
      nav_status: record.navStatus,
      nav_status_text: record.navStatusText,
      flag: record.flag,
      flag_code: record.flagCode,
      mmsi_kind: record.mmsiKind,
      imo_valid: record.imoValid,
      sanctioned: record.sanctioned,
      sanction_confidence: record.sanctionConfidence,
      sanction_programs: record.sanctionPrograms,
      estimated: record.estimated,
      est_moved: record.estMoved,
      est_age_sec: record.estAgeSec,
      est_confidence: record.estConfidence,
      est_from_lat: record.estFromLat,
      est_from_lon: record.estFromLon,
