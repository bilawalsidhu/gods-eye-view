/**
 * ITU Maritime Identification Digits → flag state.
 *
 * The first three digits of a ship-station MMSI identify the administration
 * that issued it, which is the vessel's flag. This is a static lookup table
 * rather than a network call: MIDs change on the order of once a year, and a
 * flag lookup must never depend on an upstream being reachable.
 *
 * Generated from the ITU MID list. Each entry is [ISO-3166 alpha-2, name].
 * @type {Record<number, [string, string]>}
 */
export const MID_COUNTRIES = Object.freeze({
  201: ['AL', 'Albania'],
  202: ['AD', 'Andorra'],
  203: ['AT', 'Austria'],
  204: ['PT', 'Azores'],
