...
const LIVE_PACKS = [
  ...
  {
    name: 'pkc',
    enabled: () => envEnabled('CCTV_PKC_ENABLED'),
    load: loadPkcSourcesFromCatalog,
  },
  {
    name: 'scotland-webcams',
    enabled: () => envEnabled('CCTV_SCOTLAND_WEBCAMS_ENABLED'),
    load: loadScotlandWebcamSourcesFromCatalog,
  },
];
/**
