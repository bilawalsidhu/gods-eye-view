...
- Package: `@jtarrio/signals` 0.10.0
- Author: Jacobo Tarrio Barreiro
- Source: <https://github.com/jtarrio/signals>
- License: Apache License 2.0
- License text: <https://www.apache.org/licenses/LICENSE-2.0>

The implementation was informed by the behavior of
<https://github.com/samehkhamis/websdr> at commit
`bb847b15bf653b1620cbfc502499b26be7744172`. No source files or assets from that
