...
| **Mapillary Graph API** | Viewport-bounded street-level image locations, thumbnails and capture metadata (optional BYOK) | [Mapillary terms](https://www.mapillary.com/terms) and contributor imagery under [CC BY-SA](https://help.mapillary.com/hc/en-us/articles/115001770409-CC-BY-SA-license-for-open-data); fetched live, never stored | Linked “Mapillary contributors” credit while displayed, plus creator and original-image link when selected |
