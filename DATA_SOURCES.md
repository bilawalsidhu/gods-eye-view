...
| **NASA NeoWs (Near Earth Object Web Service)** | Near-Earth asteroid close approaches (7-day window, near-earth-objects layer) | NASA Open API terms (api.nasa.gov); data sourced from NASA/JPL CNEOS | "NASA NeoWs / JPL CNEOS" (courtesy) |
