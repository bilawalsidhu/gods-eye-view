...
| **OpenStreetMap (Nominatim)** | Reverse-geocoded place label in the cockpit Local Info page, and keyless forward geocoding for the location search box / voice fly-to when no Google Maps key is configured | ODbL 1.0 + Nominatim usage policy | "© OpenStreetMap contributors" |
