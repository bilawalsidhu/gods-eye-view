...
| **OpenStreetMap (Overpass API)** | Viewport-bounded civic offices — police stations, town halls, government offices | ODbL 1.0 | "© OpenStreetMap contributors" (community-mapped and incomplete; the layer reports its in-view count and the answering mirror's snapshot date rather than a total) |
