...
CCTV_PKC_ENABLED="${CCTV_PKC_ENABLED:-1}"
CCTV_SCOTLAND_WEBCAMS_ENABLED="${CCTV_SCOTLAND_WEBCAMS_ENABLED:-1}"
...
put_env CCTV_PKC_ENABLED "${CCTV_PKC_ENABLED}"
put_env CCTV_SCOTLAND_WEBCAMS_ENABLED "${CCTV_SCOTLAND_WEBCAMS_ENABLED}"
