...
export const CREDENTIALS = Object.freeze([
  ...
  { name: 'XWEATHER_CLIENT_ID', label: 'Xweather precipitation client ID', keychain: [['xweather-api', 'client-id'], ['xweather-api', 'client_id']] },
  { name: 'XWEATHER_CLIENT_SECRET', label: 'Xweather precipitation client secret', keychain: [['xweather-api', 'client-secret'], ['xweather-api', 'client_secret']] },
  {
